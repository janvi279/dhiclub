                        ...
                        <div className="w-32 h-32 bg-gray-200 rounded-xl flex items-center justify-center text-gray-500 mb-3 overflow-hidden">
                            {newResponsibility.Photo ? (
                                <>
                                    ...
                                    <button type="button" onClick={() => setNewResponsibility({ ...newResponsibility, Photo: null })} className="absolute top-1 right-1 text-gray-800 font-semibold cursor-pointer rounded-full px-2 py-1 text-sm">✕</button>
                                </>
                            ) : (
                                <span className="text-sm">No Photo</span>
                            )}
