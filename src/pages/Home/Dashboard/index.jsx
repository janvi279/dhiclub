...
import Teams from "../../dhiclub/Teams";
import Members from "../../dhiclub/Members";
import State from "../../controllers/State";
import City from "../../controllers/City";
import Country from "../../controllers/Country";
import Leads from "../../CRM/Leads";
import Registration from "../../dhiclub/Registration";
...
const Dashboard = () => {
    ...
    return (
        <>
            <div
                className={` max-sm:px-5 w-full  transition-all duration-300 `}
            >
                <h1
