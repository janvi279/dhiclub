...
const BusinessType = () => {
  ...
  const handleSave = (values) => {
    if (editData) {
      updateBusinessType({ ...editData, ...values });
    } else {
  ...
  return (
    <div className="mx-auto  bg-white shadow-lg border border-primary-800 rounded-lg p-5">
      {/* Header */}
      <div className="flex flex-wrap gap-4 items-center justify-between pb-11 border-b border-gray-200 mb-4">
        <h1 className="text-primary-150 font-semibold text-xl">Business Type</h1>
