...
const Country = () => {
  ...
  return (
    <div className="mx-auto mt-10 bg-white border-primary-800 border rounded-lg p-5">
      {/* Header + Filters */}
      <div className="flex flex-wrap gap-4 items-center justify-between pb-4  border-gray-200 mb-4">
